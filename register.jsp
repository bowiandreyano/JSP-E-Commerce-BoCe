...
<div class="header">
     ...
     <div class="container">
          ...
          <div class="logo">
               <h1 ><a href="index.html"><b>T<br>H<br>E</b>Ece Store<span>The Best Supermarket</span></a></h1>
          </div>
          <div class="head-t">
               <ul class="card">
                    <li><a href="login.html" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
                    <li><a href="http://<% out.println(request.getServerName()); %>:8080/Widyakharisma/register"><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
...
<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
     <ul class="nav navbar-nav ">
          <li ><a href="http://<% out.println(request.getServerName());%>:8080/Widyakharisma/index.jsp" class="hyper "><span>Home</span></a></li>	
