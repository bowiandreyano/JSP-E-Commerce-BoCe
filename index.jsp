...
<html>
<head>
<title>Boce store a Ecommerce Online Shopping </title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="head-t">
				<ul class="card">
					...
					<li><a href="shipping.html" ><i class="fa fa-ship" aria-hidden="true"></i>Q+A</a></li>
				</ul>	
			</div>
...
<div data-vide-bg="video/video">
    <div class="container">
		<div class="banner-info">
			<h3>Enjoy Our Services And Happy Shopping !!! </h3>	
		...
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">Special</a></li>
					</ul>
				</nav>
						...
						<div class=" con-w3l">
							...
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="http://<% out.println(request.getServerName()); %>:8080/Widyakharisma/Single?IDProduct=<% out.println(prod[0]); %>"><% out.println(prod[1]); %></a>(<% out.println(prod[7]); %>)</h6>							
										</div>
										<div class="mid-2">
											<p ><em class="item_price"><% out.println(prod[2]); %></em></p>
